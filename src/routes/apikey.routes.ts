...
import { apiCreationRL, generalApiKeyLimiter } from "../middlewares/ratelimiting.middleware.js";
...
router.post("/revoke/apikey/:keyId",generalApiKeyLimiter,apiKeyController.revokeApiKey);
